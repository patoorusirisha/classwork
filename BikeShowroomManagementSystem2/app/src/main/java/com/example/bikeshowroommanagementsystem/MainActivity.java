package com.example.bikeshowroommanagementsystem;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkCrededentials() {
        ...
        String userpws1=upws.getText().toString();
            String s=RegisterEvent.sp.getString("mail","");
            String p=RegisterEvent.sp.getString("password","");
if ((useremail1.equals(s) )&& (userpws1.equals(p)))
    ...
    public void register(View view) {
        Intent intent=new Intent(getBaseContext(),RegisterEvent.class);
